...
class Constants
{
  ...
  static const AppBarLeaders          =    ["GANESH GALLERY", "गणेश गैलरी"];
  static const AppBarSongs            =    ["GANESH AARTI", "गणपति बप्पा की आरती"];
  static const AppBarNameLetters      =    ["NAME LETTERS", "नाम के अक्षर"];
  static const AppBar108Names         =    ["108 NAMES", "१०८ नाम"];
  static const AppBarShayari          =    ["GANESH PUJA", "गणेश पूजा"];
  static const AppBarStatus           =    ["VIDEO STATUS", "गणपति बप्पा के वीडियो"];
  static const AppBarIndia            =    ["GANPATI BAPPA", "गणपति बप्पा"];
  ...
  static const OrangeColor            =     Color(0xFFFF1493);
  static const WhiteColor             =     Color(0xFFFFFFFF);
  static const BlueColor              =     Color(0xFF800000);
