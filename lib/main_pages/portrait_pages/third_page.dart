...
class _ThirdPageState extends State<ThirdPage> with TickerProviderStateMixin
{
  ...
  [
    "assets/images/asset_01.jpeg",
    "assets/images/asset_02.jpeg",
    "assets/images/asset_03.jpeg",
    "assets/images/asset_04.jpeg",
    "assets/images/asset_05.jpg"
  ];
        ...
        body: AnimatedBackground(
          behaviour: RainParticleBehaviour(
            options:  ParticleOptions(
              image: Image.asset('assets/images/flower7.png'),
              spawnOpacity: 1,
                      ...
                      child: Container(
                        child: Row(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(width: 5,),
                              Text("PREV".toUpperCase(), style: TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.bold)
                              ),
                            ]
                        ),
                      ),
                    ...
                    child: Container(
                      child: Row(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(width: 5,),
                            Text("RESET".toUpperCase(), style: TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.bold)
                            ),
                          ]
                      ),
                    ),
                      ...
                      child: Container(
                        child: Row(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(width: 5,),
                              Text("NEXT".toUpperCase(), style: TextStyle(fontSize: 15, color: Colors.white, fontWeight: FontWeight.bold)
                              ),
                            ]
                        ),
                      ),
...
Transform _customToBackTransform(Widget item, double fraction, double curveFraction, double cardHeight, double cardWidth, int fromPosition, int toPosition)
{
  ...
  return Transform.translate(
    ...
    child: Transform.scale(
      scale: scale,
      child: Transform(
        transform: Matrix4.identity()..setEntry(3, 2, 0.002)..rotateY(rotateY),
...
class RainParticleBehaviour extends RandomParticleBehaviour
{
  ...
  bool enabled;
  RainParticleBehaviour({ParticleOptions options = const ParticleOptions(), Paint? paint, this.enabled = true}) : assert(options != null), super(options: options, paint: paint);
